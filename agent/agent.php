...
$agent_check = mysqli_query(
    $con,
    "SELECT * FROM user WHERE uid='$uid' AND utype='agent' LIMIT 1"
);
    ...
    <style>
        ...
        * {
        ...
        /* =====================================================
           ...
           Image is deliberately much taller than
           the banner.

           The banner acts like a viewing window.

           The image moves vertically from TOP
           towards BOTTOM as the page scrolls.
           ===================================================== */
...
(function () {
    ...
    function updateImagePosition() {
         ...
         *
         * The image is 200% tall,
         * allowing a large visible
         * vertical movement.
         */
