                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                             ...
                             * STATE SELECTION FIX
                             *
                             * The page can receive the state as:
                             *
                             * stateproperty.php?id=Gujarat
                             *
                             * OR
                             *
                             * stateproperty.php?state=Gujarat
                             *
                             * This prevents the Undefined array key "id"
                             * warning and makes the state filter reliable.
                             */
                            ...
                            elseif (isset($_GET['state']) && trim($_GET['state']) !== '') {
                            ...
                            if ($state !== '') {
                                ...
                                $query = mysqli_query(
                                    ...
                                    "SELECT property.*, user.uname, user.utype, user.uimage
                                     ...
                                     AND LOWER(TRIM(property.state)) = LOWER(TRIM('$state'))"
                                );
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="featured-thumb hover-zoomer mb-4">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        ...
                                        <div
                                            class="px-4 pb-4 d-inline-block w-100"
                                        >
                            ...
                            ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="alert alert-warning">
                                        ...
                                        Please select a state to view properties.
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-widget">
                            ...
                            <h4
                                class="double-down-line-left text-secondary position-relative pb-4 my-4"
                            >
                                Instalment Calculator
                            </h4>
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
                                ...
                                <li>
                                    ...
                                    <h6
                                        class="text-secondary hover-text-primary text-capitalize"
                                    >
