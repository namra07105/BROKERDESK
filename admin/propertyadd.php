...
if(isset($_POST['add']))
{
	...
	move_uploaded_file($temp_name7,"property/$aimage7");
	move_uploaded_file($temp_name8,"property/$aimage8");
	
	$sql="insert into property (title,pcontent,type,bhk,stype,bedroom,bathroom,balcony,kitchen,hall,floor,size,price,location,city,state,feature,pimage,pimage1,pimage2,pimage3,pimage4,pimage5,pimage6,pimage7,pimage8,uid,status,totalfloor,uploaded_by)
	values('$title','$content','$ptype','$bhk','$stype','$bed','$bath','$balc','$kitc','$hall','$floor','$asize','$price',
	'$loc','$city','$state','$feature','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$aimage5','$aimage6','$aimage7','$aimage8','$uid','$status','$totalfloor','$uploaded_by')";
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img id="preview_aimage" src="" alt="" height="150" width="180" style="display:none; margin-top:10px;">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img id="preview_aimage2" src="" alt="" height="150" width="180" style="display:none; margin-top:10px;">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img id="preview_aimage4" src="" alt="" height="150" width="180" style="display:none; margin-top:10px;">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Image 6</label>
													<div class="col-lg-9">
														<input class="form-control" name="aimage6" type="file" required="">
														<img id="preview_aimage6" src="" alt="" height="150" width="180" style="display:none; margin-top:10px;">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Image 8</label>
													<div class="col-lg-9">
														<input class="form-control" name="aimage8" type="file" required="">
														<img id="preview_aimage8" src="" alt="" height="150" width="180" style="display:none; margin-top:10px;">
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img id="preview_aimage1" src="" alt="" height="150" width="180" style="display:none; margin-top:10px;">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img id="preview_aimage3" src="" alt="" height="150" width="180" style="display:none; margin-top:10px;">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img id="preview_aimage5" src="" alt="" height="150" width="180" style="display:none; margin-top:10px;">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Image 7</label>
													<div class="col-lg-9">
														<input class="form-control" name="aimage7" type="file" required="">
														<img id="preview_aimage7" src="" alt="" height="150" width="180" style="display:none; margin-top:10px;">
													</div>
												</div>
