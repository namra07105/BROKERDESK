...
{ 
    ...
    { 
        ...
        { 
             ...
             */
            header("Location: cityadd.php?msg=" . urlencode("<p class='alert alert-success'>City Inserted Successfully</p>"));
            exit();
        } 
        else 
        { 
                        ...
                        <div class="card-body"> 
                            ...
                            > 
                                ...
                                <tbody> 
                                    ...
                                    $query = mysqli_query(
                                        $con,
                                        "SELECT city.*,state.sname 
                                         FROM city,state 
                                         WHERE city.sid=state.sid"
                                    ); 
                                    ...
                                    <tr> 
                                        ...
                                        <td>
                                            <a href="cityedit.php?id=<?php echo $row['0']; ?>">
                                                Edit
                                            </a>
                                        </td> 

                                        <td>
                                            <a href="citydelete.php?id=<?php echo $row['0']; ?>">
                                                Delete
                                            </a>
                                        </td> 
